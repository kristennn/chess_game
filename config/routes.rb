Rails.application.routes.draw do
  ...
  namespace :api, :default => { :format => :json} do
    namespace :game do
      ...
      post "groupMember/:joinGroup" =>                    "playerinfos#join_group"
      get "groupinfos/:getGroupinfo" =>                   "playerinfos#get_groupinfo"
      get "groupPlayers/:getGroupPlayer" =>               "playerinfos#get_group_player"
      post "groupPlayers/:deleteGroupPlayer" =>           "playerinfos#delete_group_player"
      post "/groupPerson/:quitGroup" =>                   "playerinfos#quit_group"
      post "/groupOwners/:disbandGroup" =>                "playerinfos#disband_group"
